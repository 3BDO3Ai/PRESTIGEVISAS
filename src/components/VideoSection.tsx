    ...
    <section id="video" className="py-24 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Video Container */}
          <div className="order-1 lg:order-2 video-container aspect-video bg-gradient-to-br from-navy to-navy-800 flex items-center justify-center cursor-pointer group relative overflow-hidden">
            ...
            <div className="text-center relative z-10">
              ...
              <p className="text-gold/60 text-xs mt-1">2 min video</p>
            </div>
          </div>
        </div>
      </div>
